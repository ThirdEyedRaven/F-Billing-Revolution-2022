...
######################## TAB=7-CUSTOMER SECTION-GOKUL P G #######################################################################
...
def add_customer():
      ...
      labelframe2.place(x=5,y=40,width=420,height=150)
      name = Label(labelframe2, text="Ship to name:",bg="#f5f3f2",fg="blue").place(x=5,y=5)
      spname = Entry(labelframe2,width=28)
      spname.place(x=130,y=5)
      addr = Label(labelframe2, text="Address:",bg="#f5f3f2",fg="blue").place(x=5,y=40)
      ...
      labelframe4.place(x=5,y=195,width=420,height=150)
      name = Label(labelframe4, text="Contact person:",bg="#f5f3f2").place(x=5,y=5)
      cprsn = Entry(labelframe4,width=28)
      cprsn.place(x=130,y=5)
      email = Label(labelframe4, text="E-mail address:",bg="#f5f3f2",fg="blue").place(x=5,y=35)
      cemail = Entry(labelframe4,width=28)
      cemail.place(x=130,y=35)
      tel = Label(labelframe4, text="Tel.number:",bg="#f5f3f2").place(x=5,y=65)
      ctno = Entry(labelframe4,width=11)
      ctno.place(x=130,y=65)
      fax = Label(labelframe4, text="Fax:",bg="#f5f3f2").place(x=240,y=65)
      ...
      labelframe5.place(x=480,y=195,width=420,height=125)
      name = Label(labelframe5, text="Contact person:",bg="#f5f3f2").place(x=5,y=5)
      sprsn = Entry(labelframe5,width=28)
      sprsn.place(x=130,y=5)
      email = Label(labelframe5, text="E-mail address:",bg="#f5f3f2").place(x=5,y=35)
      semail = Entry(labelframe5,width=28)
      semail.place(x=130,y=35)
      tel = Label(labelframe5, text="Tel.number:",bg="#f5f3f2").place(x=5,y=65)
      stno = Entry(labelframe5,width=11)
      stno.place(x=130,y=65)
      fax = Label(labelframe5, text="Fax:",bg="#f5f3f2").place(x=240,y=65)
      sfax = Entry(labelframe5,width=11)
      sfax.place(x=280,y=65)

      labelframe6 = LabelFrame(labelframe1,text="Contact",bg="#f5f3f2")
      labelframe6.place(x=5,y=350,width=420,height=100)
      Checkbutton(labelframe6,text="Tax Exempt",variable=checkvar2,onvalue=1,offvalue=0,bg="#f5f3f2").place(x=5 ,y=5)
      b11val = Label(labelframe6, text="Specific Tax1 %:",bg="#f5f3f2").place(x=180,y=5)
      b11val = Entry(labelframe6,width=10)
      b11val.place(x=290,y=5)
      disnt = Label(labelframe6, text="Discount%:",bg="#f5f3f2").place(x=5,y=35)
      disnt = Entry(labelframe6,width=10)
      disnt.place(x=100,y=35)
      ...
      labelframe9 = LabelFrame(labelframe1,text="Notes",bg="#f5f3f2")
      labelframe9.place(x=480,y=430,width=420,height=150)
      nts = Entry(labelframe9)
      nts.place(x=10,y=10,height=100,width=390)
...
def reg_1():# Storing values into db (user)contp,cemail,ctel,cfax,cmob,scontp,scemail,sctel,scfax,ccountry,ccity
  ...
  businessaddress = address.get()
  category= ca.get()
  shipname= spname.get()
  shipaddress = spaddress.get()
  contactperson= cprsn.get() 
  cpemail = cemail.get()
  cptelno = ctno.get() 
  cpfax = cfax.get()
  cpmobileforsms = cnsms.get()
  shipcontactperson= sprsn.get()
  discount=disnt.get()
  specifictax1=b11val.get()
  shipcpemail= semail.get()
  shipcptelno= stno.get()
  shipcpfax = sfax.get()
  country= cntry.get()
  city = cty.get()
...
def delete_customer():
    ...
    delmess = messagebox.askyesno("Delete Customers", "Are you sure want to delete 1 Customer(s) ?")
    if delmess == True:
      itemid = customertree.item(customertree.focus())["values"][1]
      print(itemid)
      ...
      customertree.delete(customertree.selection()[0])
    else:
      pass
...
customertree=ttk.Treeview(tab7,selectmode='browse')
customertree.place(x=0,y=100,height=570)
vertical_bar=ttk.Scrollbar(tab7,orient="vertical")
vertical_bar.place(x=1083,y=101,height=570)
customertree["columns"]=("1","2","3","4","5","6","7","8")
customertree["show"]='headings'
customertree.column("1",width=2,anchor='c')
customertree.column("2",width=170,anchor='c')
customertree.column("3",width=190,anchor='c')
customertree.column("4",width=176,anchor='c')
customertree.column("5",width=176,anchor='c')
customertree.column("6",width=120,anchor='c')
customertree.column("7",width=130,anchor='c')
customertree.column("8",width=120,anchor='c')
customertree.heading("1",text="")
customertree.heading("2",text="Customer ID")
customertree.heading("3",text="Category")
customertree.heading("4",text="Customer Name")
customertree.heading("5",text="Contact Persion")
customertree.heading("6",text="Customer Tel.")
customertree.heading("7",text="SMS Number")
customertree.heading("8",text="Type")
